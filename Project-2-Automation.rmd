...
```{r main-one, warning = FALSE, message = FALSE}
...
Create output file names. Use the file names with the render function to automate creation of reports for each day.

```{r main-two, message = FALSE, results = 'hide'}
