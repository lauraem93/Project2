...
```
    ...
    ## Warning in cor(select(bikeSummary, season:cnt)): the standard deviation is zero
...
![](SundayAnalysis_files/figure-gfm/unnamed-chunk-6-6.png)<!-- -->
...
![](SundayAnalysis_files/figure-gfm/unnamed-chunk-6-8.png)<!-- -->
...
![](SundayAnalysis_files/figure-gfm/unnamed-chunk-6-9.png)<!-- -->
...
![](SundayAnalysis_files/figure-gfm/unnamed-chunk-6-10.png)<!-- -->
...
![](SundayAnalysis_files/figure-gfm/unnamed-chunk-6-11.png)<!-- -->
